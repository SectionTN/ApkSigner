...
import com.light.apksigner.utils.Event;
...
public class SignerViewModel extends AndroidViewModel implements ApkSignerWrapper.SignerCallback {
    ...
    public void sign(File apkFile) {
        ...
        ApkSignerWrapper.getInstance(mContext).sign(apkFile, getSignedApkFilePath(apkFile), this);
    }
